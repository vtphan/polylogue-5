...
For **v1**, Lens should be judged mainly by whether it can support a coherent single-session path through:

- noticing something worth discussing
- pointing to a concrete turn or move
- making an initial interpretation
- comparing with peers
- making a basic evaluative judgment
- ending with a lightweight transfer move back to PBL discussion
...
For v1, visible mastery of named reasoning dimensions and repeated growth across sessions should be treated as **emerging or deferred goals**, not minimum success criteria for the first implementation.
...
- **Support fading over time**  
  Provide stronger supports earlier and reduce them gradually as students gain familiarity. This is likely a later-version strategy unless v1 grows a meaningful cross-session progression model.
...
- **Transfer prompts**  
  Connect the work on episodes back to students' own PBL discussions and collaborative reasoning. In v1 this can be a lightweight closing move rather than a full longitudinal reflection system.
...
- **Flexible pacing**  
  The activity should work under different classroom timing conditions. Some groups may need more structure while others can self-regulate more easily. V1 should therefore support natural stopping points and resumable phase state without assuming one fixed period structure or requiring live teacher control. In v1, pacing support should come from explicit structural checkpoints rather than smart inference.
...
- essential in v1:
  ...
  - scaffolded deepening
  - meaningful gamification
  - lightweight transfer prompt
  - momentum and engagement by design
  - flexible pacing with clear stopping points

- more naturally v2 or later:
  - support fading over time
  - explicit longitudinal progression across sessions
  - visible teaching of named reasoning dimensions as a core layer
...
- **Pacing control**  
  How the app should support student self-regulation and lightweight pacing guidance without becoming brittle when a class moves faster or slower than expected.
...
AI provides prepared examples, support, and perspective aligned with the taxonomy and instructional strategies. In v1, that role may be delivered primarily through embedded supports rather than a standalone labeled AI perspective screen. It should help students notice, interpret, and deepen discussion without becoming the classroom authority, a live tutor, or a replacement for peers and teachers.
...
## 6. Brief Vision For v2

If v1 succeeds, v2 should build upward rather than sideways.

Likely v2 directions:

- stronger cross-session progression for the same students over time
- support fading based on prior use and demonstrated readiness
- more visible use of reasoning dimensions such as logic, evidence, and scope
- richer transfer from episode analysis back into students' own PBL discussions
- a clearer prepared-AI role once the runtime contract is stable

V2 should not replace the low-floor v1 experience. It should extend it into a more explicit progression model with a higher instructional ceiling.
